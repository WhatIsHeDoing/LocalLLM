...
data_spinner = Halo("Loading local data...", spinner="dots")
data_spinner.start()
...
data_spinner.stop_and_persist(emojize(":open_file_folder:"), "Local data loaded")

print(emojize(":plus: Preloading the LLM with local content..."))
